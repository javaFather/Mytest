...
<head>
    ...
    <![endif]-->
    <link rel="shortcut icon" href="favicon.ico"> <link href="resources/css/bootstrap.min.css?v=3.3.6" rel="stylesheet">
...
<div id="wrapper">
            ...
            <ul class="nav" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level" >
                        <li>
                            <a class="J_menuItem" href="/main/user" target="user">用户信息</a>
                        </li>
                        <li>
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li>
                            <a class="J_menuItem" href="blog/51cto.html">51cto</a>
                        </li>
                        <li>
                ...
                <li>
                    <a class="J_menuItem" href="/resources/css_animation.html"><i class="fa fa-magic"></i> <span class="nav-label">CSS动画</span></a>
                </li>
                <li>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="row J_mainContent" id="content-main">
            <iframe id="J_iframe" width="100%" height="100%" src="/main/index" frameborder="0" data-id="index_v1.html" seamless></iframe>
        </div>
    </div>
    <!--右侧部分结束-->
    <iframe>
        <iframe id="user" name="user" width="100%" height="100%" frameborder="0" data-id="index_v1.html" seamless></iframe>
    </iframe>
</div>
<!-- 全局js -->
