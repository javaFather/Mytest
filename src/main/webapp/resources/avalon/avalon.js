...
*/(function (global, factory) {
    ...
    var compaceQuote = function () {
        //https://github.com/bestieresources/js/json3/blob/master/lib/json3.js
        var Escapes = {
            92: "\\\\",
            34: '\\"',
            8: "\\b",
    ...
    */
    ...
    function dispatch(event) {
        ...
        while ((handler = handlers[i++]) && !event.cancelBubble) {
            ...
            while (uuid = handler.uuids[j++]) {
                if (event.stopIm/resources/mediate) {
                    break;
                }
    ...
    var eventProto = {
        ...
        stopIm/resources/mediatePropagation: function stopIm/resources/mediatePropagation() {
            this.stopPropagation();
            this.stopIm/resources/mediate = true;
        },
        toString: function toString() {
    ...
    */
    ...
    if (!canHideProperty) {
        ...
        if (msie$1 < 9) {
            ...
            var VB/resources/mediator = function VB/resources/mediator(instance, accessors, name, value) {
                // jshint ignore:line
            ...
            createViewModel = function createViewModel(name, accessors, properties) {
                ...
                var ret = window[className + 'Factory'](accessors, VB/resources/mediator); //得到其产品
                return ret; //得到其产品
            };
        }
    }
    ...
    //https://github.com/adform/validator.resources/js/blob/master/validator.js
